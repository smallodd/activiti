...
public class TaskAdapter implements TaskManager {
    ...
    public Result taskAction(TaskActionParam taskActionParam) {
        ...
        if (TaskActionEnum.CLAIM.value.equals(actionType)) {
            ...
            //问询
            return WorkflowService.taskEnquire(taskActionParam.getUserId(), taskActionParam.getTaskId(), taskActionParam.getTargetTaskDefKey(), taskActionParam.getCommentResult());
