...
public class ActivitiUtil {
    ...
    public static ActivitiUtil activitiUtil;
    ...
    public void passProcess(String taskId, Map<String, Object> variables)
            throws Exception {
        List<Task> tasks =  taskService.getSubTasks(taskId);
    ...
    public void jointProcess(String taskId, List<String> userCodes)
        ...
        for (String userCode : userCodes) {
            TaskEntity task = (TaskEntity) taskService.newTask(uuidGenerator
                    .getNextId());
    ...
    private boolean isJointTask(String taskId){
        ...
        if(tUserTask != null && "counterSign".equals(tUserTask.getTaskType())){
            return true;
        }
        return false;
    }
