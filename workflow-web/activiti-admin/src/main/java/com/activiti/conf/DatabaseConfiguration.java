...
public class DatabaseConfiguration {
    ...
    public DataSource dataSource() {
        ...
        if (StringUtils.isNotEmpty(dataSourceJndiName)) {
            ...
            String dataSourceUrl = env.getProperty("datasource.url", "jdbc:mysql://127.0.0.1:3306/activiti-admin?characterEncoding=UTF-8");

            String dataSourceUsername = env.getProperty("datasource.username", "root");
            String dataSourcePassword = env.getProperty("datasource.password", "root");
