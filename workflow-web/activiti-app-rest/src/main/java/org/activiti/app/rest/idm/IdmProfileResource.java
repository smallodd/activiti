...
public class IdmProfileResource {
  ...
  public void changePassword(@RequestBody ChangePasswordRepresentation changePasswordRepresentation) {
    ...
    String originalPassword = identityService.encodePassword(changePasswordRepresentation.getOriginalPassword());

    if (!user.getPassword().equals(originalPassword)) {
      throw new NotFoundException();
    }
    user.setPassword(identityService.encodePassword(changePasswordRepresentation.getNewPassword()));
    identityService.saveUser(user);
  }
